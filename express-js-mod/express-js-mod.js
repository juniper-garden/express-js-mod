...
const Default404 = Object.freeze({
  headers: Object.freeze(["Content-type", "text/html"]),
      ...
      switch (message) {
        ...
        case MessageValue.requestComplete:
          if (!bodyParseMap[this.inboundRequest.headers["content-type"]]) {
            ...
            this.inboundRequest.data =
              bodyParseMap[this.inboundRequest.headers["content-type"]](val1);
          }
